        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_Brokers_FkBrokerId",
                        column: x => x.FkBrokerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accesses_RFIDCards_FkRFIDCardId",
            ...
            migrationBuilder.InsertData(
                table: "RFIDCards",
                columns: new[] { "Id", "FkCardOwnerId" },
                values: new object[] { "1022787718182", 2 });

            migrationBuilder.InsertData(
                table: "RFIDCards",
                columns: new[] { "Id", "FkCardOwnerId" },
                values: new object[] { "687777954811", 1 });
