        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FkIdBroker = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_Brokers_FkIdBroker",
                        column: x => x.FkIdBroker,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FkCardOwnerId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RFIDCards", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RFIDCards_CardOwners_FkCardOwnerId",
                        column: x => x.FkCardOwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FkRFIDId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Accesses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Accesses_RFIDCards_FkRFIDId",
                        column: x => x.FkRFIDId,
                        principalTable: "RFIDCards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Accesses_Rooms_FkRoomId",
                        column: x => x.FkRoomId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RFIDCards_FkCardOwnerId",
                table: "RFIDCards",
                column: "FkCardOwnerId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Rooms_FkIdBroker",
                table: "Rooms",
                column: "FkIdBroker");
        }
